...
1. Native installer (macOS/Linux/Windows, **builds from source**)
2. Homebrew (macOS, prebuilt binaries from GitHub Releases)

For the native installer, you need:
...
# or:
# brew tap seashail/seashail
# brew install seashail
```
